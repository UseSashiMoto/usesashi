...
export function validateSignedKey(key: string, signedKey: string, secretKey: string) {
    console.log("validateSignedKey key", key, signedKey, secretKey)
    console.log("valid key?",generateSignedKey(key, secretKey), signedKey, generateSignedKey(key, secretKey) === signedKey)
